...
import { DIRECTOR_MIN_WIDTH, HIDDEN_WIDGETS, MIN_SEG, RULER_H, SEG_LABEL_H, THUMB_JPEG_Q, THUMB_MAX_W, THUMB_PREFETCH_BATCH, TIMELINE_SYNC_DEBOUNCE_MS, TRACK_H } from "../core/layout_spec.js";
...
import { bindFl2vEvents, buildFl2vPayloadFields, ensureFl2vTimeline, fl2vStartIndices, flushFl2vPromptDraft, getFl2vSampleFrames, getFl2vTotalDurationSec, getFl2vVisualFrames, mountFl2vPanel, newFl2vShot, normalizeFl2vSegments, openFl2vUpload, removeFl2vShot, setFl2vToolbar, syncFl2vFromShots, updateFl2vDetailUI, updateFl2vToolbarBtns } from "../minimax_fl2v.js";
import { CUSTOM_ASPECT_RATIO, DEFAULT_ASPECT_RATIO, DEFAULT_MEGAPIXELS, MAX_GEN_FRAMES, MAX_REFERENCE_AUDIOS, MAX_REFERENCE_IMAGES, MAX_REFERENCE_VIDEOS, MINIMAX_CANVAS_MULTIPLE, NO_VIDEO_UPLOAD_TASKS, RESOLUTION_ASPECTS, clampMegapixels, defaultDurationSec, defaultFrameCount, durationToClampedMiniMaxFrames, framesToDurationSec, genLayoutHint, getDirectorMode, imageBatchRequiresFixedOutput, isContinuityMasterEnabled, isCustomAspectRatio, isPromptBatchTask, isSegmentContinuityFromPrev, isVideoBatchTask, minFrameCount, newBatchSegment, normalizeAspectRatioLabel, normalizeRefImageSize, parseMegapixelsInput, preferredDurationSecFromFrames, refAudioLabel, refImageLabel, refVideoLabel, resolutionFromSelector, resolveSegmentRefImageSize, resolveTaskKey, roundDurationSec, snapResolutionDim, sumFrameCounts, taskUsesReferenceAudios, taskUsesReferenceImages, taskUsesReferenceVideo } from "../minimax_gen_timeline.js";
import { applyI18nDom, aspectDisplayLabel, getLocale, onLocaleChange, t, taskDisplayLabel, toggleLocale } from "../minimax_i18n.js";
import { addImageBatchGroup, bindDomWidgetContentComputeSize, bindImageBatchEvents, bindR2vMediaPlayback, contentDomWidgetMinHeight, deleteImageBatchGroup, ensureImageBatchTimeline, flushBatchPromptInputs, formatMediaDuration, isBatchDetailSolo, mountImageBatchPanel, normalizeImageBatchSegments, rebaseR2vGroupSlotsForCommon, renderImageBatchGroups, setR2vToolbar, setToolbarDisabledForBatch, syncBatchPanelFillHeight, updateR2vToolbarBtns, wireBatchRunSelectControls, wireMediaDuration } from "../minimax_image_batch.js";
